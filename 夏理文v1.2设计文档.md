...
::n7,i1,o6:l4,a6::北風::j7,o1,u6:l4,a6::日
::l4,a6:: ,,::ai-:s:o:p:o:s::,,
...
::i:b4,a6:k4,u6:l4,a6::北風::c7,o1,a6::最製::l4,e6::風 ::i:k7,u1,i6:l4,o6:n4,u6:: ::sym#d+w6:b4,y6:b4,y6:sym#d+w6:: 增::l4,e6:k4,a6::製::l4,e6:x4,o6:k4,au6::風::c4,u6::使::l4,o6:n4,u6:l4,e6:p4,a6::旅::c4,u6::作::l4,e6:k4,a6::增::l4,e6:k4,a6:s4,e6:l7,a1,u6:l4,i6:x4,o6:k4,au6:s4,e6::緊::l4,e6::衣 ::i:b4,a6:z4,a6:b4,o6:l4,a6::北風::c7,o1,u6::試
...
構幹可以佔據 1x1 株大小（全角）或 0.5x0.5 株大小（小角），構幹分爲立式和臥式兩種形式，還分爲重音與非重音變體。立式構幹可以佔據 0.5x1 株大小（左右半角），而臥式構幹可以佔據 1x0.5 株大小（上下半角），在合法但不規範的情況下兩者還可以佔據另外一種半角。構幹的兩種形式是服務於不同結構的構字株的，將會在後面詳細說明。
...
各部件的起名方式是 「構幹 {重音}{立式/臥式}{元音/雙元音名稱}」，例如 ::u-0:: 叫作「構幹 重音臥式u」 或 「terbasna pinta me me'o ubu stura stani」。
...
構字株的組合結構，在設計上考慮了視線的運動方向。每種結構各部件，按照順序掃視觀看，視線可以向上、向下、向右移動，但是不會向左移動。

記得添加臥式佔據左右部分，立式佔據上下部分
