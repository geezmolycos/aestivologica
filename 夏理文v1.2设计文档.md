...
::i0:b4,a6:k4,u6:l4,a6::北風::c7,o01,a6::最製::l4,e6::風 ::i0:k7,u01,i6:l4,o6:n4,u6:: ::sym#d+w6:b4,y6:b4,y6:sym#d+w6:: 增::l4,e6:k4,a6::製::l4,e6:x4,o6:k4,au6::風::c4,u6::使::l4,o6:n4,u6:l4,e6:p4,a6::旅::c4,u6::作::l4,e6:k4,a6::增::l4,e6:k4,a6:s4,e6:l7,a01,u6:l4,i6:x4,o6:k4,au6:s4,e6::緊::l4,e6::衣 ::i0:b4,a6:z4,a6:b4,o6:l4,a6::北風::c7,o01,u6::試
::i0:b4,a6:k4,u6:l4,a6::日::c7,o01,a6::耀::l4,o6::柔熱 ::i0:b4,a6:z4,i6:b4,o6:l4,e6:p4,a6::旅::c7,o01,u6::着::l4,e6::衣
...
各部件的起名方式是「構枝 {輔音名稱}」，例如 ::s:: 叫作「構枝 sy」或「me me'o sy. stura jimca」。
...
各部件的起名方式是 「構幹{重音}{立式/臥式}{元音/雙元音名稱}」，例如 ::u-0:: 叫作「構幹重音臥式u」 或 「terbasna pinta me me'o ubu stura stani」。
...
具體來說，就是前元音都是由一條主幹和若干橫線組成，後元音有兩條豎線，央元音只有 y 一個元音，爲 ::y:: 形，高元音特性爲於中央，低元音位於上方。
重音以元音末尾的鉤表示。
...
構字株是由若干個部件按照一定排列規則組成的一個字，一般佔一個漢字大小。一個構字株由若干個構字部件組成，根據情況不同，一個株可以代表語音的一個音節，或者一個音素等。部件和株的關係基本上可類比於諺文的部件（字母）和音節的關係。「株」的概念不只適用於構字，它是一個通用的代表「大約一個漢字大小」完整字符的名稱。不同的組合方式可以用來表示不同的音節結構，且不同的組合方式也是用來適應不同的詞語類型，不同的形態學情況的。這些更高層的規則將會在後面章節中詳細介紹。本節將先枚舉常見的（規範的）的構字株組合結構，以及它們所代表的音節（音素序列），然後再敘述構字株組合和其代表音素系列的通用規則，可以涵蓋規範和不規範的任意合法組合形式。
...
.grid-box > div {
    ...
    overflow: hidden;
    border-right: 0.5px solid var(--color-text); /* 容器左上、子元素右下 */
    border-bottom: 0.5px solid var(--color-text); /* 容器左上、子元素右下 */
}
