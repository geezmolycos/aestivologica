...
花林是一種涵蓋多個意字株（也可以包含構字株）的結構，用來給最優類 lujvo 形式或未簡化類 lujvo 形式下的意字株省略意字葉，適合在 lujvo 或 rafsi 組合出的 cmevla 中使用，使意字株的書寫更簡潔。花林由意字花、連接線和意字株（或構字株）組成，結構形如：

頂標花林：^^::box#f,#0+x4+cr,s#ol6:box#f,#1+x4+cr,s#ol4,s#ol6:box#f,#2+x4+cr,s#ol4,s#ka8:box#f,#3+x4+cr,s#ol4,s#k3:box#f,#4+x4+cr,s#ol4,s#ol6:box#f,#5+x4+cr,s#f0::^^
