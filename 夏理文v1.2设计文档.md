...
| - | - | - | - | - | - |
| 終葉 | ^^::s#l2+s2+x1+y1:: ::s#l-2+s2+x1+y1::^^ | ^^::corner#full,s#k2:: ::corner#full,s#k-2::^^ | ^^::corner#half4+h,s#l2:: ::corner#half4+h,s#l-2::^^ | CCV+"+ | 泛終株 |
| 重音終葉 | ^^::s#ls2+s2+x1+y1:: ::s#ls-2+s2+x1+y1::^^ | ^^::corner#full,s#ks2:: ::corner#full,s#ks-2::^^ | ^^::corner#half4+h,s#ls2:: ::corner#half4+h,s#ls-2::^^ | CC<b>V+'+</b> | 泛終株 |
| 間葉 | ^^::s#l6+s2+x1+y1:: ::s#l-6+s2+x1+y1::^^ | ^^::corner#full,s#k6:: ::corner#full,s#k-6::^^ | ^^::corner#half4+h,s#l6:: ::corner#half4+h,s#l-6::^^ | CV+"+C | 泛間株 |
| 重音間葉 | ^^::s#ls6+s2+x1+y1:: ::s#ls-6+s2+x1+y1::^^ | ^^::corner#full,s#ks6:: ::corner#full,s#ks-6::^^ | ^^::corner#half4+h,s#ls6:: ::corner#half4+h,s#ls-6::^^ | C<b>V+'+</b>C | 泛間株 |
| 單葉 | ^^::s#l4+s2+x1+y1:: ::s#l-4+s2+x1+y1::^^ | ^^::corner#full,s#k4:: ::corner#full,s#k-4::^^ | ^^::corner#half4+h,s#l4:: ::corner#half4+h,s#l-4::^^ | CV+"+G | 泛間株（泛單株） |
| 重音單葉 | ^^::s#ls4+s2+x1+y1:: ::s#ls-4+s2+x1+y1::^^ | ^^::corner#full,s#ks4:: ::corner#full,s#ks-4::^^ | ^^::corner#half4+h,s#ls4:: ::corner#half4+h,s#ls-4::^^ | C<b>V+'+</b>G | 泛間株（泛單株） |
| 雙葉 | ^^::s#l8+s2+x1+y1:: ::s#l-8+s2+x1+y1::^^ | ^^::corner#full,s#k8:: ::corner#full,s#k-8::^^ | ^^::corner#half4+h,s#l8:: ::corner#half4+h,s#l-8::^^ | CV+"+'V+"+ | 疊二株 |
| 前重音雙葉 | ^^::s#ls8+s2+x1+y1:: ::s#ls-8+s2+x1+y1::^^ | ^^::corner#full,s#ks8:: ::corner#full,s#ks-8::^^ | ^^::corner#half4+h,s#ls8:: ::corner#half4+h,s#ls-8::^^ | C<b>V+'+</b>'V+"+ | 疊二株 |
| 後重音雙葉 | ^^::s#la8+s2+x1+y1:: ::s#la-8+s2+x1+y1::^^ | ^^::corner#full,s#ka8:: ::corner#full,s#ka-8::^^ | ^^::corner#half4+h,s#la8:: ::corner#half4+h,s#la-8::^^ | CV+"+'<b>V+'+</b> | 疊二株 |
| 全重音雙葉 | ^^::s#ld8+s2+x1+y1:: ::s#ld-8+s2+x1+y1::^^ | ^^::corner#full,s#kd8:: ::corner#full,s#kd-8::^^ | ^^::corner#half4+h,s#ld8:: ::corner#half4+h,s#ld-8::^^ | C<b>V+'+</b>'<b>V+'+</b> | 疊二株 |
...
<span class="red">1</span>: 非 gismu 的詞，則原形式倒數第二個\<VD\\y>爲重音，其餘爲非重音，如果不滿兩個，則唯一一個爲重音。
<span class="red">2</span>: 非 gismu 的詞，則原形式最後一個\<VD\\y>爲重音，其餘爲非重音。
<span class="red">3</span>: 非 gismu 的詞，則原形式每個\<VD\\y>均爲重音。

終葉、間葉、單葉、雙葉這四種對應 short rafsi 的意字葉有兩種形式，如果該 rafsi 來自 gismu 的字母靠前，則使用第一種形式，否則使用第二種形式。如果該 rafsi 不來自 gismu，則使用第一種形式。這樣對 gismu 來說不使用 rafsi 詞典就可以直接確定意字株對應的音素串，具體爲：

| rafsi 形式 | gismu 字母順序 | gismu 形式 | 意字葉形式 |
| - | - | - | - |
| CCV | 123 | <span class="yellow">CCVCV(終)</span> | 第一終葉 ::s#l2+s2+x1+y1:: |
| CCV | 132 | <span class="blue">CVCCV(間)</span> | 第一終葉 ::s#l2+s2+x1+y1:: |
| CCV | 345 | <span class="blue">CVCCV(間)</span> | 第二終葉 ::s#l-2+s2+x1+y1:: |
| CVC | 134 | <span class="yellow">CCVCV(終)</span> | 第一間葉 ::s#l6+s2+x1+y1:: |
| CVC | 234 | <span class="yellow">CCVCV(終)</span> | 第二間葉 ::s#l-6+s2+x1+y1:: |
| CVC | 123 | <span class="blue">CVCCV(間)</span> | 第一間葉 ::s#l6+s2+x1+y1:: |
| CVC | 124 | <span class="blue">CVCCV(間)</span> | 第二間葉 ::s#l-6+s2+x1+y1:: |
| CVV | 135 | <span class="yellow">CCVCV(終)</span> | 第一單葉 ::s#l4+s2+x1+y1:: |
| CVV | 235 | <span class="yellow">CCVCV(終)</span> | 第二單葉 ::s#l-4+s2+x1+y1:: |
| CVV | 125 | <span class="blue">CVCCV(間)</span> | 第一單葉 ::s#l4+s2+x1+y1:: |
| CV'V | 13'5 | <span class="yellow">CCVCV(終)</span> | 第一雙葉 ::s#l8+s2+x1+y1:: |
| CV'V | 23'5 | <span class="yellow">CCVCV(終)</span> | 第二雙葉 ::s#l-8+s2+x1+y1:: |
| CV'V | 12'5 | <span class="blue">CVCCV(間)</span> | 第一雙葉 ::s#l8+s2+x1+y1:: |
...
頂標花林：^^::box#f,#0+x4+cr,s#ol6:box#f,#1+x4+cr,s#ol4,s#ol6:box#f,#2+x4+cr,s#ol4,s#k8:box#f,#3+x4+cr,s#ol4,s#k3:box#f,#4+x4+cr,s#ol4,s#ol6:box#f,#5+x4+cr,s#f0::^^

中標花林：^^::box#f,#0+x4+cr:s#e+h:box#f,#1+x4+cr:s#e+h:box#f,#2+x4+cr:s#e+h,s#l8:box#f,#3+x4+cr:s#e+h,s#l3:box#f,#4+x4+cr:s#e+h:box#f,#5+x4+cr:s#e0+h::^^

<span class="red">0</span>: 起始株，頂標花林的話右半上劃線
<span class="red">1</span>: 單獨出現的漢字，作爲沒有意字葉的意字株，在花林中作爲整體的一部分考慮，其形式受意字花指定。頂標的上劃線貫穿
<span class="red">2</span>: 有非空意字葉的意字株，表示意字葉指定的形式，頂標的情況下，上劃線給意字葉讓步，中標的情況下，中劃線和意字葉共存
<span class="red">3</span>: 有標重音的意字株，形式仍然未定，受意字花指定
<span class="red">4</span>: 除漢字外，構字株也可以出現在花林內，必須表示一個或若干個 rafsi，其表示形式爲自身
<span class="red">5</span>: 結束株，頂標花林左側上標標記意字花，右側留給結束株的意字株。中標形式若要標記意字葉，則先寫中劃線，其上標記意字葉，然後再寫意字花。中標形式當意字花是短花時，不寫出。

一個花林具體表示什麼音素串，首先由其中形式確定的 rafsi，包括有非空意字葉的意字株、構字株這些，施加限制條件，然後看意字花，如果意字花指定的是未簡化形式，則剩餘未確定形式的株，全部視作 long rafsi 形式，最後一個詞視作 gismu 形式。如果意字花指定的是最優形式，則要先計算所有 rafsi 構成複合詞的所有形式，然後在其中選擇符合已確定形式株條件下的最優形式。rafsi 間的連字符一般是不明確寫出來的，而是未簡化形式或最優形式複合詞其中蘊含的，如果要寫的話必須使用下標形式（如果是中標花林，則連字符可寫在中劃線下方，上標花林直接寫出即可），使其和 rafsi 有區分。擴展語法下，如果有的 rafsi 比較長，構字株中包含下標小字，在規範形式下它必然不是輔音或者 y。因此我們認爲，下標小字凡是輔音或y的，它就是連字符，否則就是 rafsi 的一部分。
...
這個實現假設你使用的 lojban 方言有一個確定性的 lujvo/複合 cmevla 枚舉和評分算法，以及 lujvo/複合 cmevla 解析算法，當然這個算法也不一定非要是官方的，lojban 在近些時間有人對什麼是 rafsi，還有什麼連字符是允許的，這些問題有各種不同的意見，還有語法上的擴展。如果這些擴展允許現有詞語新形態的 rafsi，則你可以添加新的意字葉形式。如果這些擴展允許新的連字符，只用意字葉時本來就要顯式寫出，並不會影響使用，而用意字花時，我們又是從 rafsi 出發，一般是忽略連字符的，使用什麼連字符是算法中決定的，因此也不影響使用。如果這些擴展允許不定形態的 rafsi（例如 zi'evla），則可以使用構字株寫出，爲了區分 rafsi 邊界，中標花林有中劃線本身就可以區分，而上標花林中，需要在不能區分的 rafsi 邊界處添加中劃線。
